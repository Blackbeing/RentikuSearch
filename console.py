...
base_subparsers = base_parser.add_subparsers(title="subcommands",
                                             help="subcommands help")
create_parser = base_subparsers.add_parser("create", help="Create Object")
create_subparsers = create_parser.add_subparsers(title="subcommands",
                                                 help="subcommands help")
create_user_parser = create_subparsers.add_parser("user", help="Create user")

create_user_parser.add_argument("-u",
                                "--username",
                                required=True,
                                help="username")
...
create_property_parser = create_subparsers.add_parser("property",
...
create_property_parser.add_argument("-d",
                                    "--description",
                                    help="Property Description")
create_property_parser.add_argument("-l",
                                    "--location",
                                    help="Property location")
create_property_parser.add_argument("-p",
                                    "--price",
                                    type=float,
                                    help="Property price")
create_property_parser.add_argument("-u",
                                    "--owner-id",
                                    type=int,
                                    help="Property owner")
...
show_user_parser.add_argument("-a",
                              "--all",
                              action="store_true",
                              help="Show all users")
...
show_subparsers = show_parser.add_subparsers(title="subcommands",
                                             help="subcommands help")
show_property_parser = show_subparsers.add_parser("property",
                                                  help="Show property")
show_property_parser.add_argument("-a",
                                  "--all",
                                  action="store_true",
